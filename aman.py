...
async def start_yukki():
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await shy(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await shy(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await shy(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await shy(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await aan(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await aan(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await aan(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await aan(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await ake(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await ake(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await ake(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await ake(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await eel(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await eel(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await eel(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await eel(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await khu(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await khu(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await khu(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await khu(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await shi(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await shi(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await shi(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await shi(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await yaa(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await yaa(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await yaa(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await yaa(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await dav(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await dav(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await dav(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await dav(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await raj(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await raj(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await raj(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await raj(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await put(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await put(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await put(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await put(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tsix:
        ...
        try:
            ...
            await eag(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await eag(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await eag(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await eag(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await eag(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tseven:
        ...
        try:
            ...
            await gle.start()
            await gle(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await gle(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await gle(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await gle(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await gle(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
    ...
    if tnine:
        ...
        try:
            ...
            await aaa.start()
            await aaa(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await aaa(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await aaa(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await aaa(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await aaa(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
    ...
    if thirty:
        ...
        try:
            ...
            await boy.start()
            await boy(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await boy(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await boy(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await boy(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await boy(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
...
async def ping(e):
    if e.sender_id in SMEX_USERS:
        start = datetime.now()
        text = "❀ɖǟʀӄǟʍǟռ ɖǟʀӄ ʍʊʟȶɨ ֆքǟʍ ɮօȶ ❀❀!"
        event = await e.reply(text, parse_mode=None, link_preview=None )
        end = datetime.now()
        ms = (end-start).microseconds / 1000
        await event.edit(f" 𝙋𝙄𝙉𝙂 !\n`{ms}` ms{ALIVE_NAME} ❀❀ɖǟʀӄǟʍǟռ ɖǟʀӄ ʍʊʟȶɨ ֆքǟʍ ɮօȶ❀❀")
